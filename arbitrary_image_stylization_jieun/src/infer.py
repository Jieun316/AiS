...
def parse_args():
    ...
    parser.add_argument('--style_path', type=str, default='../images/style/511.jpg', help='Path of style image.')
    parser.add_argument('--style_prediction_bottleneck', type=int, default=100)
    parser.add_argument('--ckpt_path', type=str, default='../checkpoint/ais.ckpt', help='Path of checkpoint.')
