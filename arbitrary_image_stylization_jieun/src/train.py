...
def main(args):
    ...
    with tqdm(initial=step, total=args.max_step + 1) as pbar:
        ...
        for step in range(args.max_step + 1):
            ...
            # print([item for i, item in enumerate(dataloader)])
            ...
            print("c, s shape: ", content.shape, style.shape)
...
def parse_args():
    ...
    parser.add_argument('--size', type=int, default=32, help='Image size for both content and style.')
    ...
    parser.add_argument('--vgg_ckpt', type=str, default='../checkpoint/vgg.ckpt', help='Path of vgg checkpoint.')
    parser.add_argument('--inception_v3_path', type=str, default='../checkpoint/inception_v3.ckpt',
